      ...
      <div className="relative container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            We create modern web and mobile applications, scalable software
            systems, and digital experiences that help businesses grow. Our
            focus is on delivering high-quality solutions, continuous
            innovation, and practical learning opportunities for future
            developers.
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Building fast, secure, and scalable applications for web and mobile.",
              },
              {
                title: "Creative Solutions",
                desc: "Transforming ideas into practical digital products with clean design.",
              },
              {
                title: "Continuous Growth",
                desc: "Learning, improving, and delivering better experiences every day.",
              },
            ].map((item, i) => (
              <div
                key={item.title}
